...
Runs locally via Docker Compose by default. Since everything is
containerized, the deployment target is swappable:

- [`deploy/azure/README.md`](deploy/azure/README.md) — Azure VM path
  (used for this project; Azure for Students gives near-instant, no-card
  signup for a university email)
- [`deploy/aws/README.md`](deploy/aws/README.md) — AWS EC2 path, plus a
  documented ECS/Fargate stretch goal
